...
public:
	...
	int test_H(cl_ulong nnodos, cl_float sparsefactor, int reps, int instances[], int numElems, bool debug);
	...
	int test_alltimes_GPU(cl_ulong nnodos, int reps, cl_float sparsefactor[], int numElems, bool debug);
	int test_alltimes_CPU(cl_ulong nnodos, int reps, cl_float sparsefactor[], int numElems, bool debug);
